...
class ReviewLabelerACTest {
    ...
    void problemSample_caseInsensitiveWithOriginalCasing() {
        ...
        assertEquals(
                ...
                ReviewLabelerAC.label(review, tokens));
    }
    ...
    void noMatches_returnsOriginalReview() {
        ...
        assertEquals(review, ReviewLabelerAC.label(review, tokens));
    }

    @Test
    void emptyReview_returnsEmpty() {
        assertEquals("", ReviewLabelerAC.label("", tokens("airbnb", "business")));
    }

    @Test
    void emptyTokenMap_returnsOriginalReview() {
        String review = "Airbnb in San Francisco.";
        assertEquals(review, ReviewLabelerAC.label(review, Map.of()));
    }
    ...
    @Test
    void suffixPatterns_bothReported_longestWinsAtSameStart() {
        String review = "she";
        Map<String, String> tokens = tokens("she", "pronoun", "he", "pronoun");

        assertEquals("[pronoun]{she}", ReviewLabelerAC.label(review, tokens));
    }
}
